...
\includegraphics[scale=0.25,angle=270]{lectures/160513/inline.pdf}
...
\includegraphics[scale=0.5]{lectures/160513/NMIA.pdf} \\
...
\includegraphics[scale=0.3]{lectures/160513/Dimethylsulfat.pdf} \\
...
\includegraphics[scale=1]{lectures/160513/CMCT.pdf} \\

\subsubsection{Kethoxal}
Kethoxal modifiziert ungepaartes Guanin \\
\includegraphics[scale=0.3]{lectures/160513/Kethoxal.pdf}

\subsection{Nucleotide analoge interference mapping (NAIM)}
\includegraphics[scale=0.7]{lectures/160513/NAIM.jpg} \\
